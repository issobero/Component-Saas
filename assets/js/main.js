(function($) {
  var main = function() {
    this.VERSION = "1.0.0";
    this.AUTHOR = "DocomoIot";
    this.SUPPORT = "takashi.isobe@accenture.com";
    this.$body = $('body');
    //COLORS
  ...
  main.prototype.initHorizontalMenu = function() {
  ...
  // Tooltip
  main.prototype.initTooltipPlugin = function() {
    $.fn.tooltip && $('[data-toggle="tooltip"]').tooltip();
  }
  // Popover
  main.prototype.initPopoverPlugin = function() {
    $.fn.popover && $('[data-toggle="popover"]').popover();
  }
  // Retina Images
  main.prototype.initUnveilPlugin = function() {
    $.fn.unveil && $("img").unveil();
  }
  // Auto Scroll Up
  main.prototype.initScrollUp = function() {
    $('[data-main="scrollup"]').click(function () {
      $("html, body").animate({
        scrollTop: 0
      }, 700);
      return false;
    ...
    $(window).scroll(function () {
      if ($(this).scrollTop() > 100) {
        $('[data-main="scrollup"]').fadeIn();
      } else {
        $('[data-main="scrollup"]').fadeOut();
      }
    });
  }
  // Portlet / Panel Tools
  main.prototype.initPortletTools = function() {
    var $this = this;
  ...
  // Scrollbar Plugin
  main.prototype.initScrollBar = function(){
  ...
  // Sidebar
  main.prototype.initSideBar = function(){
  ...
  // Sidebar Toggler
  main.prototype.initSideBarToggle = function(){
    var $this = this;
    $('[data-main="toggle-left-side"]').on('touchstart click', function (e) {
      e.preventDefault();
      $this.toggleLeftSideBar();
    });
    $('[data-main="toggle-right-side"]').on('touchstart click', function (e) {
      e.preventDefault();
      $this.toggleRightSideBar();
    });
  }
  // Left Side Bar / Chat view
  main.prototype.toggleLeftSideBar = function(){
    var timer;
  ...
  main.prototype.toggleRightSideBar = function(){
    var timer;
  ...
  main.prototype.initUtil = function(){
    ...
    $('[data-main-toggler="checkall"]').on('click', function () {
      var $el = $(this);
  ...
  main.prototype.initProgress = function(){
  ...
  // Select2 Plugin
  main.prototype.initSelect2Plugin = function() {
  ...
  // Form Elements
  main.prototype.initFormElements = function(){
  ...
  // Validation Plugin
  main.prototype.initValidatorPlugin = function() {
  ...
  // Block UI
  main.prototype.blockUI = function(el){
    $(el).block({
  ...
  main.prototype.unblockUI = function(el){
    $(el).unblock();
  }
  // Call initializers
